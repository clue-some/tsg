...
function displayUsers(){
   ...
   $q = "SELECT username, userlevel, email, timestamp "
       ."FROM ".TBL_USERS." JOIN ".TBL_KNOWN_USER." ON id = user_id "
   ...
   echo "<tr><td><b>Username</b></td><td><b>Level</b></td><td><b>Email</b></td><td><b>Member Since</b></td></tr>\n";
...
function displayBannedUsers(){
   ...
   $q = "SELECT username, timestamp "
       ."FROM ".TBL_KNOWN_USER." JOIN ".TBL_BANNED_USERS
